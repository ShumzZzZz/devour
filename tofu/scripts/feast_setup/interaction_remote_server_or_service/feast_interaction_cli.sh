...
curl "http://[fs-external-url]/get-online-features" \
--json '{
		"features": ["fv_push_product_bestseller_ethnicity_tag:short_term_products_ethnic_tag"],
		"entities": {"ethnicity_user": ["Chinese"]}
	}' | jq

curl "http://[fs-external-url]/get-online-features" --json '{"features": ["fv_push_user_propensity_score:user_type","fv_push_user_propensity_score:score"], "entities": {"user_id": [7216502, 93590]}}' | jq

curl "http://[fs-internal-url]/get-online-features" --json '{"features": ["fv_push_user_propensity_score:user_type","fv_push_user_propensity_score:score"], "entities": {"user_id": [7216502, 93590]}}' | jq

curl "http://[fs-external-url]/get-online-features" --json '{"features": ["fv_push_user_propensity_score:score"], "entities": {"user_id": [7216502]}}' | jq
curl "http://[fs-internal-url]/feast/get-online-features" --json '{"features": ["fv_push_user_propensity_score:score"], "entities": {"user_id": [7216502]}}' | jq
